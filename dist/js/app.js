(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-product__slider")) new core(".slider-product__slider", {
    ...
    function digitsCounter() {
        ...
        function digitsCountersAnimate(digitsCounter) {
            ...
            const step = timestamp => {
                ...
                digitsCounter.innerHTML = parseFloat((progress * (startPosition + startValue)).toFixed(1));
